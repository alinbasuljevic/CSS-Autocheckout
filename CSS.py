...
def AutoCheckout():
    ...
    shipping_payload = {
        ...
        'shipping[street][]': '3 Fabri Court',
        'shipping[street][]': '3 Fabri Court',
        'shipping[city]': 'Mahopac',
        'shipping[region_id]': '43',
        'shipping[region]': '',
        'shipping[postcode]': '10541',
        'shipping[save_in_address_book]': '1',
        'shipping[use_for_billing]': '1',
        'shipping[telephone]': '9148822962',
        'shipping[email]': 'abasuljevic@gmail.com',
        'subscribe': 'on',
    ...
    billing_info = {
        ...
        'billing[street][]': '3 Fabri Court',
        'billing[street][]': '3 Fabri Court',
        'billing[city]': 'Mahopac',
        'billing[region_id]': '43',
        'billing[region]':'', 
        'billing[postcode]': '10541',
        'billing[save_in_address_book]': '1',
        'billing[email]': 'abasuljevic@gmail.com',
        'billing[telephone]': '9148822962',
        'payment[method]': 'cybersource_soap',
        'payment[cc_type]': 'VI',
        'payment[cc_number]': '4403931141096025',
